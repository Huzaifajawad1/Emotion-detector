...
lemoji BYTE"    AAAAAAA        AAAAAA", 13, 10
  BYTE "AAAAAAAAA      AAAAAAAA", 13, 10
BYTE  "AAAAAAAAAAA    AAAAAAAAAA", 13, 10
BYTE "AAAAAAAAAAAAA  AAAAAAAAAAAA", 13, 10
BYTE"AAAAAAAAAAAAAAAAAAAAAAAAAAAAA", 13, 10
BYTE"BBBBBBBBBBBBBBBBBBBBBBBBBBBBB", 13, 10
 BYTE"BBBBBBBBBBBBBBBBBBBBBBBBBBB", 13, 10
  BYTE"BBBBBBBBBBBBBBBBBBBBBBBBB", 13, 10
   BYTE"BBBBBBBBBBBBBBBBBBBBBBB", 13, 10
    BYTE"BBBBBBBBBBBBBBBBBBBBB", 13, 10
     BYTE"BBBBBBBBBBBBBBBBBBB", 13, 10
      BYTE"BBBBBBBBBBBBBBBBB", 13, 10
       BYTE"BBBBBBBBBBBBBBB", 13, 10
        BYTE"BBBBBBBBBBBBB", 13, 10
         BYTE"BBBBBBBBBBB", 13, 10
          BYTE"BBBBBBBBB", 13, 10
           BYTE"BBBBBBB", 13, 10
            BYTE"BBBBB", 13, 10
             BYTE"BBB", 13, 10
              BYTE"B",13, 10, 13, 10, 13, 10,0
;-------------------------------------------------------------------------------------------------------- CODE BLOCK ---------------------------------------------------------------------------------------------------------
.code
